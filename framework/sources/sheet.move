...
module stable_layer_framework::sheet;

use std::type_name::{with_defining_ids as get, TypeName};
use sui::balance::{Self, Balance};
use sui::vec_map::{Self, VecMap};
use sui::vec_set::{Self, VecSet};
use stable_layer_framework::liability::{Self, Credit, Debt};
...
#[test_only]
public use fun loan_destroy_for_testing as Loan.destroy_for_testing;
#[test_only]
public fun loan_destroy_for_testing<T, L, R>(loan: Loan<T, L, R>): Balance<T> {
    let Loan { balance, debt } = loan;
